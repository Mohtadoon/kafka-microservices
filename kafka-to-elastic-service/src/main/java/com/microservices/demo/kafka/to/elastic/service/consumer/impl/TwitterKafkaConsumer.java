...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        List<TwitterIndexModel> documents = avroToElasticModelTransformer.getElasticModels(messages);

        List<String> documentsId = elasticIndexClient.save(documents);

        LOG.info("Documents are saved to elastic search with ids {}", documentsId.toArray());
